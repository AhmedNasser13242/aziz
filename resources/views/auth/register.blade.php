                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="bg-white padding_eight_all">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">انشئ حساب</h1>
                                            <p class="mb-30">لديك بالفعل حساب؟<a href="{{ route('login') }}">سجل</a>
                                            </p>
                                        </div>
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="exampleCheckbox12"><span>I
                                                                اوافق علي الشروط &amp; والسياسة.</span></label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group mb-30">
                                                <button type="submit"
                                                    ...
                                                    name="login">اكمل &amp; تسجيل جديد</button>
                                            </div>
