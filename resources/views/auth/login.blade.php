                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="bg-white padding_eight_all">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">تسجيل</h1>
                                            <p class="mb-30">لا تملك حساب؟ <a href="{{ route('register') }}">انشئ حسابك
                                                </a></p>
                                        </div>
                                                ...
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="exampleCheckbox1"><span>تذكرني</span></label>
                                                    </div>
                                                </div>
                                                <a class="text-muted" href="{{ route('password.request') }}">نسيت كلمة
                                                    المرور؟
                                                </a>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-heading btn-block hover-up"
                                                    name="login">سجل </button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
