                 ...
                 <ul class="nav nav-tabs links" id="myTab" role="tablist">
                     <li class="nav-item" role="presentation">
                         <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one"
                             type="button" role="tab" aria-controls="tab-one" aria-selected="true">جميع</button>
                     </li>
                     ...
                     <div class="tab-pane fade" id="category{{ $category->id }}" role="tabpanel"
                         ...
                         <div class="row product-grid-4">
                                             ...
                                             <div class="product-card-bottom">
                                                 ...
                                                 @else
                                                     <div class="product-price">
                                                         <span>ر.س{{ $product->discount_price }}</span>
                                                         <span
                                                             class="old-price">ر.س{{ $product->selling_price }}</span>
                                                     </div>
                                                 @endif
                             ...
                             @empty
                                 ...
                                 <h5 class="text-danger"> لم يتم العثور على منتج </h5>
                             @endforelse
