...
<div class="container">
    ...
    <div class="section-title wow animate__animated animate__fadeIn" data-wow-delay="0">
        <h3 class="">كل قائمة البائعين لدينا </h3>
                ...
                <div class="vendor-wrap mb-40">
                    <div class="vendor-img-action-wrap">
                        ...
                        <div class="product-badges product-badges-position product-badges-mrg">
                            <span class="hot">{{ $vendor->email }}</span>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between align-items-end mb-30">
                            <div>
                                <div class="product-category">
                                    <span class="text-muted">منذ {{ $vendor->vendor_join }}</span>
                                </div>
                                <h4 class="mb-5"><a
                                ...
                                <div class="product-rate-cover">
                                    ...
                                    <span class="font-small total-product">{{ count($products) }} منتجات</span>
                                </div>
                            </div>
                        ...
                        <div class="vendor-info mb-30">
                            <ul class="contact-infor text-muted">
                                ...
                                <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}"
                                        alt="" /><strong>اتصل بنا:</strong><span>{{ $vendor->phone }}</span>
                                </li>
                            </ul>
                        </div>
                        <a href="{{ route('vendor.details', $vendor->id) }}" class="btn btn-xs">قم بزيارة المتجر <i
