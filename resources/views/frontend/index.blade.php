...
<section class="product-tabs section-padding position-relative">
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            <h3>{{ $skip_category_0->category_name }} فئة </h3>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div>
                                        @if ($product->vendor_id == null)
                                            <span class="font-small text-muted">البائع <a
                                                    href="vendor-details-1.html">المالك</a></span>
                                        @else
                                            <span class="font-small text-muted">البائع <a
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        <div class="add-cart">
                                            <a class="add" href="{{ route('mycart') }}"><i
                                                    class="mr-5 fi-rs-shopping-cart"></i>اضف </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="product-tabs section-padding position-relative">
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            <h3>{{ $skip_category_2->category_name }} فئة </h3>
...
<section class="product-tabs section-padding position-relative">
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            <h3>{{ $skip_category_7->category_name }} فئة </h3>
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        <div class="add-cart">
                                            <a class="add" onclick="addToCartDetails()"><i
                                                    class="mr-5 fi-rs-shopping-cart"></i>اضف </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 wow animate__animated animate__fadeInUp"
                data-wow-delay="0">
                <h4 class="section-title style-1 mb-30 animated"> عروض مذهلة </h4>
                        ...
                        <article class="row align-items-center hover-up">
                            ...
                            <div class="mb-0 col-md-8">
                                ...
                                @if ($item->discount_price == null)
                                    <div class="product-price">
                                        <span>ر.س{{ $item->selling_price }}</span>

                                    </div>
                                @else
                                    <div class="product-price">
                                        <span>ر.س{{ $item->discount_price }}</span>
                                        <span class="old-price">ر.س{{ $item->selling_price }}</span>
                                    </div>
                                @endif
                            </div>
                        </article>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp"
                data-wow-delay=".1s">
                <h4 class="section-title style-1 mb-30 animated">عرض خاص</h4>
                <div class="product-list-small animated">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp"
                data-wow-delay=".2s">
                <h4 class="section-title style-1 mb-30 animated">أضيف مؤخرا</h4>
                <div class="product-list-small animated">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp"
                data-wow-delay=".3s">
                <h4 class="section-title style-1 mb-30 animated">صفقة خاصة</h4>
                <div class="product-list-small animated">
