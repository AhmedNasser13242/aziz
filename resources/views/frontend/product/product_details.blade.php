                ...
                <div class="row mb-50 mt-30">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            @else
                                <span class="stock-status out-stock">نفذت الكمية </span>
                            @endif
                            ...
                            <div class="clearfix product-price-cover">
                                ...
                                @if ($product->discount_price == null)
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">ر.س{{ $product->selling_price }}</span>

                                    </div>
                                @else
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">ر.س{{ $product->discount_price }}</span>
                                        <span>
                                            <span class="save-price font-md color3 ml-15">{{ round($discount) }}%
                                                Off</span>
                                            <span
                                                class="old-price font-md ml-15">ر.س{{ $product->selling_price }}</span>
                                        </span>
                                    </div>
                                @endif
                            ...
                            @else
                                <div class="attr-detail attr-size mb-30">
                                    <strong class="mr-10" style="width:50px;">مقاس : </strong>
                                    <select class="form-control unicase-form-control" id="dsize">
                                        <option selected="" disabled="">--اختر مقاس--</option>
                            ...
                            @else
                                <div class="attr-detail attr-size mb-30">
                                    <strong class="mr-10" style="width:50px;">لون : </strong>
                                    <select class="form-control unicase-form-control" id="dcolor">
                                        <option selected="" disabled="">--اختر لون--</option>
                            ...
                            <div class="detail-extralink mb-50">
                                ...
                                <div class="product-extra-link2">
                                    ...
                                    <button type="submit" class="button button-add-to-cart"
                                        onclick="addToCartDetails()"><i class="fi-rs-shopping-cart"></i>اضف الي
                                        العربة</button>
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                <div class="vendor-logo d-flex mb-30">
                                    ...
                                    <div class="vendor-name ml-15">
                                        @if ($product->vendor_id == null)
                                            <h6>
                                                <a href="vendor-details-2.html">المالك</a>
                                            </h6>
                                        @else
                                            <h6>
                            ...
                            <div class="tab-pane fade" id="Reviews">
                                ...
                                <div class="comments-area">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="#" class="font-xs text-muted">كيف اتحسب التقييمات</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="comment-form">
                                    <h4 class="mb-15">اضف تقييم</h4>

                                    @guest
                                        <p> <b>لكي تستطيع اضافة تقييمك تحتاج لتسجيل الدخول اولا <a
                                                    href="{{ route('login') }}">سجل من هنا</a> </b></p>
                                    @else
                                        <div class="row">
                                            <div class="col-lg-8 col-md-12">
                                                <form class="form-contact comment_form"
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" class="button button-contactForm">احفظ
                                                            التقييم</button>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            @if ($product->discount_price == null)
                                                <div class="product-price">
                                                    <span>ر.س{{ $product->selling_price }}</span>

                                                </div>
                                            @else
                                                <div class="product-price">
                                                    <span>ر.س{{ $product->discount_price }}</span>
                                                    <span class="old-price">ر.س{{ $product->selling_price }}</span>
                                                </div>
                                            @endif
