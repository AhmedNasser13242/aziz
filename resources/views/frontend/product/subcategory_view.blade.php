    ...
    <div class="row flex-row-reverse">
        <div class="col-lg-4-5">
            <div class="shop-product-fillter">
                <div class="totall-product">
                    <p>وجدنا <strong class="text-brand">{{ count($products) }}</strong> عناصر لك!</p>
                </div>
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            ...
            <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                <h5 class="section-title style-1 mb-30">منتجات جديدة </h5>
                ...
                @foreach ($newProduct as $product)
                    <div class="single-post clearfix">
                        ...
                        <div class="content pt-10">
                            ...
                            @if ($product->discount_price == null)
                                <p class="price mb-0 mt-5">ر.س{{ $product->selling_price }}</p>
                            @else
                                <p class="price mb-0 mt-5">ر.س{{ $product->discount_price }}</p>
                            @endif
