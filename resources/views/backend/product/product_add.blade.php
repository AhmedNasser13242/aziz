...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
            <div class="breadcrumb-title pe-3">اضف منتج جديد</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="p-0 mb-0 breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">اضف منتج جديد</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="p-4 card-body">
                <h5 class="card-title">اضف منتج جديد</h5>
                <hr />
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="p-4 border rounded border-3">
                                    ...
                                    <div class="mb-3 form-group">
                                        <label for="inputProductDescription" class="form-label">وصف صغير</label>
                                        <textarea name="short_descp" class="form-control" id="inputProductDescription" rows="3"></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputProductDescription" class="form-label">وصف كبير</label>
                                    ...
                                    <div class="mb-3 form-group">
                                        <label for="inputProductTitle" class="form-label">صور متعددة</label>
                            ...
                            <div class="col-lg-4">
                                <div class="p-4 border rounded border-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputCompareatprice" class="form-label">سعر الخصم </label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputStarPoints" class="form-label">كمية متوفرة</label>
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inputProductType" class="form-label">براند</label>
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inputVendor" class="form-label">تصنيف المنتج</label>
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inputCollection" class="form-label">تصنيف فرعي للمنتج</label>
                                        ...
                                        <div class="col-12">
                                            <label for="inputCollection" class="form-label">اختر بائع</label>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="flexCheckDefault"> عروض
                                                            مذهلة</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault">حديثة</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="special_deals"
                                                            type="checkbox" value="1" id="flexCheckDefault">
                                                        <label class="form-check-label" for="flexCheckDefault">صفقات
                                                            مميزة</label>
                                                    </div>
                                                </div>
