                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('active.vendor.approve') }}"
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">تم التسجيل في </h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">تفاصيل عن البائع</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
					...
					{{ $inactiveVendorDetails->vendor_short_info }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="px-4 btn btn-danger" value="تفعيل البائع" />
                                        </div>
                                    </div>
                            </div>
