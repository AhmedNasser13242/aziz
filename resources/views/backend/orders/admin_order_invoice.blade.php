...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>ثمار</strong></h2>
            </td>
            @php
        ...
        <tbody>
            ...
            @foreach ($orderItem as $item)
                <tr class="font">
                    ...
                    <td align="center">ر.س{{ $item->price }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <table width="100%" style=" padding:0 10px 0 10px;">
        <tr>
            <td align="right">
                <h2><span style="color: green;">المجموع الفرعي:</span>ر.س{{ $order->amount }}</h2>
