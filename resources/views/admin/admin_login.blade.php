                                ...
                                <div class="p-4 border rounded">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">بريدك الالكتروني
                                                </label>
                                                <input type="email" name="email" class="form-control" id="email"
                                                    placeholder="Email Address">
                                            </div>
                                            <div class="col-12">
                                                <label for="inputChoosePassword" class="form-label">كلمة المرور
                                                </label>
                                            ...
                                            <div class="col-md-6 text-end"> <a
                                                    href="authentication-forgot-password.html">نسيت كلمة المرور؟</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary"><i
                                                            class="bx bxs-lock-open"></i>سجل</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
